...
import type { TUserActivityLogData } from '@oyl/all-of-oyl/modules'

type Props = {
  log: TUserActivityLogData
  onSave: (patch: Partial<TUserActivityLogData>) => void | Promise<void>
  onDelete: () => void | Promise<void>
  onClose: () => void
}

export default function UserActivityLogSheet({ log, onSave, onDelete, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div
        className="bg-white dark:bg-gray-900 rounded-lg p-6 w-full max-w-md space-y-3"
