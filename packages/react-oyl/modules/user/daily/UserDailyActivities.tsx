...
import DailySectionForm from './UserDailySectionForm'
import DailySectionSettingsForm from './UserDailySectionSettingsForm'
import DailySectionSettingsModal from './UserDailySectionSettingsModal'
import DailySection from './UserDailySection'
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-black dark:text-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
