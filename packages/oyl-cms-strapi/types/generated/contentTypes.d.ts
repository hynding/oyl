...
export interface ApiConsumableServingConsumableServing
  ...
  attributes: {
    ...
    >
    measurement: Schema.Attribute.Relation<
      "oneToOne",
      "api::consumable-measurement.consumable-measurement"
    >
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiConsumableTypeConsumableType
  extends Struct.CollectionTypeSchema {
...
export interface ApiUserDietDailyUserDietDaily
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    diet: Schema.Attribute.Relation<"oneToOne", "api::user-diet.user-diet">
    journal: Schema.Attribute.Component<"diet.daily-consumables", true>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<
      "oneToMany",
...
export interface ApiUserDietUserDiet extends Struct.CollectionTypeSchema {
...
export interface ApiUserMessageUserMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    emailReplyTo: Schema.Attribute.Email & Schema.Attribute.Required
    hasRead: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<
      "oneToMany",
    ...
    > &
      Schema.Attribute.Private
    nameReplyTo: Schema.Attribute.String
    publishedAt: Schema.Attribute.DateTime
    subject: Schema.Attribute.String
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
...
export interface ApiUserResumeUserResume extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fieldSkills: Schema.Attribute.Component<"resume.skill-type", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
      }>
    hideContactFields: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
    ...
    phoneMobileNumber: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
      ...
      Schema.Attribute.SetMinMax<
        ...
        string
      >
    privateAccess: Schema.Attribute.JSON &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false
