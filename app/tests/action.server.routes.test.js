...
describe('Action CRUD tests', function() {
	...
	it('should not be able to save Action instance if no name is provided', function(done) {
	...
	it('should be able to get a single Action if not signed in', function(done) {
		...
		actionObj.save(function() {
			request(app).get('/actions/' + actionObj._id)
				.end(function(req, res) {
					// Set assertion
					res.body.should.be.an.Object.with.property('name', action.name);
